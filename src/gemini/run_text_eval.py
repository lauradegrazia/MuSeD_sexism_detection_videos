...
# Documentaation https://ai.google.dev/gemini-api/docs/text-generation?lang=python
...
parser.add_argument("--model_name", type=str, default="gemini-2.0-flash", help="Gemini model to run") # gemini-1.5-pro/ gemini-2.0-pro-exp-02-05 / gemini-2.0-flash
...
os.makedirs(args.result_path+"/outputs", exist_ok=True)
...
df["output_text"] = df["prompts"].apply(query_gemini_api)
